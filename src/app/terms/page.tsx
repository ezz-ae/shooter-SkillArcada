    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>Welcome to Luckshots! By using our platform, you agree to these terms. Please read them carefully.</p>
          ...
          <ul>
            ...
            <li>Items in the vault can be traded in for a fluctuating value in Shots or for a flat-rate amount of legacy "Luckshots."</li>
          ...
          <p>
            Luckshots is provided "as is." While we strive for a fair and fun environment, we are not responsible for any losses incurred. All transactions are final.
          </p>
