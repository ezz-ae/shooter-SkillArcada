...
export function ShoterChallenge() {
    ...
    const handleTestMe = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "Shoter couldn't generate a challenge right now. Please try again."
            });
        } finally {
            setIsLoading(false);
        }
    ...
    return (
        <Card className="shadow-2xl border-accent/20 border-2 overflow-hidden">
            <CardHeader>
                ...
                <CardTitle className="text-3xl font-black text-center">Shoter's Challenge Corner</CardTitle>
                <CardDescription className="text-lg text-center mt-1">
                    Our expert Shoter has a past he's trying to remember. He'll analyze a conversation and give you a free, personalized test!
                </CardDescription>
            </CardHeader>
